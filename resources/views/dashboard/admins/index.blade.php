    ...
    <div class="row" id="cancel-row">
        <div class="d-flex align-items-center justify-content-between">
            ...
            <div class="my-3 d-flex gap-3">
                ...
                <a href="{{ route('admins.create') }}" class="btn btn-primary">اضافة مشرف جديد</a>
                <a href="{{ route('admins.index') }}" class="btn btn-secondary">الكل :
                    {{ App\Models\User::admins()->count() }} </a>
                <a href="{{ route('admins.index', ['status' => 1]) }}" class="btn btn-success ">مفعلين :
                    {{ App\Models\User::admins()->active()->count() }}</a>
                <a href="{{ route('admins.index', ['status' => 0]) }}"class="btn btn-danger ">غير مفعلين :
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="badge badge-light-primary text-start me-2 action-edit"
                                        href="{{ route('admins.edit', $item->id) }}"><svg
                                    ...
                                    @include('dashboard.admins.model-delete')
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
