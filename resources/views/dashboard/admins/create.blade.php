@extends('layouts.app', [
    'title' => 'اضافة مشرف',
    'catName' => 'admins',
    'breadcrumbs' => [' المشرفين', 'اضافة مشرف'],
    'scrollspy' => 0,
    'simplePage' => 0,
])
...
@section('content')
    <div class="account-settings-container layout-top-spacing">
        ...
        <div class="account-content">
            <a href="{{ route('admins.index') }}" class="btn btn-danger btn-sm">رجوع</a>
                ...
                <div class="tab-pane fade show active" id="animated-underline-home" role="tabpanel"
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                            <form class="section general-info" action="{{ route('admins.store') }}" method="POST"
